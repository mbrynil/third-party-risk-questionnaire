...
from models import get_db, QuestionBankItem, User, get_answer_options, has_custom_answer_options, AVAILABLE_FRAMEWORKS, FRAMEWORK_DISPLAY
...
async def question_bank_create(
    ...
    framework_ref = ",".join(frameworks) if frameworks else None
...
async def question_bank_update(
    ...
    item.framework_ref = ",".join(frameworks) if frameworks else None
